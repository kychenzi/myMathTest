...
@Component({
  selector: 'app-math-quiz-for-baron',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './math-quiz-for-baron.component.html',
  styleUrls: ['./math-quiz-for-baron.component.css']
})
export class MathQuizForBaronComponent implements OnInit {
  questions: Question[] = [];
  ...
  loadQuiz() {
    this.quizService.getQuizForBaron().subscribe(questions => {
